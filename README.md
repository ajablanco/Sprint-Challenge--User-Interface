...
1. If you were to describe semantic HTML to the next cohort of students, what would you say?
    ...
    -Semantic HTML provides meaning for developers and also allows people with disabilities to navigate a webpage.

2. Name two big differences between ```display: block;``` and ```display: inline;```.

display: block 
    -takes up as much space as it's content
    -you can control height and width

display: inline
    -only takes up as much space as it's content
    -height and weight have no effect
...
5. Explain why git is valuable to a team of developers.
    -git is valuable because it is used to monitor and control code changes during development across several people or teams.
